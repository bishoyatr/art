...
//dd($array);
        ...
        if (isset($inputData['barcode']) && $inputData['barcode'] != '') {
            if($inputData['barcode'] == '6223001383901')$inputData['barcode'] ='1-1';
            if (strpos($inputData['barcode'], '-') !== false) {
                $new_code = $inputData['barcode'] ;
                switch ($new_code) {
                    case '1-1':
                    $new_code = '94054-94056-94057-94059-94058-94060-94061';    
                    break;
                    case '93064-93055':
                    $new_code = '93055-93056-93064';    
                    break;
                    case '91810-91616':
                    $new_code = '91616-91617-91618-91620-91621-91810';    
                    break;
                    case '91809-91083':
                    $new_code = '91083-91085-91088-91809';    
                    break;
                    case '92027-91601':
                    $new_code = '91601-91602-91606-92027';    
                    break;
                    case '91384-91377':
                    $new_code = '91377-91387-91379-91384';    
                    break;
                    default:
                    break;
                }
                $arrays = explode("-", $new_code);
                $products->whereIn('products.oracle_short_code', $arrays);
            } else {
