...
class CreateOtherCurrentAttachmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('other_current_attachments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('other_current_attachments');
    }
}
