    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">Create Curret Attachment</h3>
            </div>
            <!--begin::Form-->
            <form method="post" action="{{route('otherCurrentAttachments.store')}}" enctype="multipart/form-data">
                <div class="card-body">

                        <input class="form-control" name="product_line_id" type="hidden" value="{{$parent_id}}" />
