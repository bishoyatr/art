    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <div class="card-header">
                <h3 class="card-title">create year title attachment </h3>
            </div>
            <!--begin::Form-->
            <form method="post" action="{{route('history.store_history_attachment')}}" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                      <input class="form-control" name="product_id" type="hidden" value="{{$product_id}}" id="example-date-input"/>
                      <input class="form-control" name="type" type="hidden" value="{{$type}}" id="example-date-input"/>
                    ...
                    <div class="form-group">
                        <label for="exampleSelect1">youtube
                            <span class="text-danger">*</span></label>
                        <input class="form-control"  name="youtube" type="text" value="{{old('youtube')}}"
                               id="example-date-input"/>
                         @error('youtube')
                         <span class="text-danger">{{$message}}</span>
                         @enderror
