...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form method="post" action="{{route('users.update',$category->id)}}">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleSelect1">is Active
                            <span class="text-danger">*</span></label>
                        <input class="form-control" name="is_active" type="checkbox"  {{($category->is_active)?"checked":""}}  id="example-date-input"/>
                        @error('is_active')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="exampleSelect1">pdf allowed
                            <span class="text-danger">*</span></label>
                        <input class="form-control" name="pdf_allowed" {{($category->pdf_allowed)?"checked":""}}  type="checkbox"  id="example-date-input"/>
                        @error('pdf_allowed')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
