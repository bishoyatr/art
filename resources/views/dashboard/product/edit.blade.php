                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control" id="exampleSelect1">
                            ...
                            <option @if($product->category_id==$sub_category->cat_id) selected @endif
                            value="{{$sub_category->cat_id}}">{{$sub_category->cat_name}} - {{$sub_category->type_name}}</option>
                    ...
                    <div class="form-group">
                      ...
                      @error('is_active')
                        ...
                        <select name="product_status" class="form-control" id="exampleSelect1">
                            @foreach(\App\Models\Type::where('process',1)->get() as $item)
                                <option @if($product->product_status===$item->id) selected @endif value="{{$item->id}}">
                                    {{$item->name}}</option>
                            @endforeach
